...
void loop(){
  ...
  int sound;
   ...
   display_data(bearing);  // Display data to the LCD03
   
   delay(100);
}

void display_data(int b){    // pitch and roll (p, r) are recieved as ints instead oif bytes so that they will display corectly as signed values.
